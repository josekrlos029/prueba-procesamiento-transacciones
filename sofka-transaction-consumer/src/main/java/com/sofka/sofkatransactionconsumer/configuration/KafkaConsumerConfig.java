...
import com.sofka.sofkatransactionconsumer.infraestructure.adapters.event.EventConsumerImpl;
...
public class KafkaConsumerConfig {
    ...
    public EventConsumer eventConsumer(
        ...
        return new EventConsumerImpl(transactionService);
    }
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "sofka-transaction-consumer-group");
